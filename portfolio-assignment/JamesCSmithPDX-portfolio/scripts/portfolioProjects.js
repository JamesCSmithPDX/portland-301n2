var projectData = [
  ...
  },
  {
    ...
    contributor: 'James Smith',
    contributorUrl: 'https://TrajectoryDS',
    postDate: '2016-05-10',
    imgSrc: 'imgAssets/trajectoryds.png',
    imgAlt: 'TrajectoryDS.com',
    projDescription: '<p>I needed to create a quick on page landing page before attending the WebVisions conference. Given the quick turn-around, I customized a WordPress template.</p> <p>I used it to create a one page site for my consulting bsuiness. The site provides details the services I provide, including my new development skills.</p>'
  },
];
